...
namespace Assets.Scripts
{
    public class DataHolder : MonoBehaviour
    {
        ...
        [field: SerializeField] public TurnManagerState TurnManagerState { get; set; }
        [field: SerializeField] public WarInfo CurrentWarInfo { get; set; }
        [field: SerializeField] public WarResult CurrentWarResult { get; set; }
        
        [field: SerializeField] public MyDictionary OriginalPlayerInfos { get; set; }
        [field: SerializeField] public MyDictionary PlayerInfos { get; set; }
...
[Serializable]
public class MyDictionary : SerializableDictionary<ushort, PlayerInfo> { }
